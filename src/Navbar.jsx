  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-[#0F1A14]/90 via-[#16251D]/90 to-[#0F1A14]/90 backdrop-blur-md">
      <div className="flex items-center justify-between w-full lg:w-[95%] xl:w-[80%] mx-auto px-8 py-4">
        ...
        >
          <svg
            ...
            className="lucide lucide-menu-icon lucide-menu text-white/80"
          >
            <path d="M4 5h16" />
            <path d="M4 12h16" />
            <path d="M4 19h16" />
      ...
      >
        ...
        <div className="flex lg:hidden justify-center items-center w-fit mx-auto space-x-5 shadow shadow-[#6B8E23] py-2 px-4 rounded-full">
          <a
